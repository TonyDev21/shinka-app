...
const WhyShinka = () => {
  return (
    <div className="bg-dark-light w-full h-auto ">
        <h3 className="text-center text-3xl sm:text-4xl md:text-5xl font-montserrat py-8 font-bold text-primary-color">¿Por qué Academia LogicCraft?</h3>
        <div className="container mx-auto h-auto grid grid-cols-1 md:grid-cols-3 gap-6 px-4">
            <CardInfo
            icon={<FaBookOpenReader />} 
            title="Fácil de Aprender" 
            description="En GuimCodeX, te ayudamos a aprender de forma sencilla y sin complicaciones. Queremos que comprendas conceptos difíciles de manera clara, adaptándonos siempre a tu propio ritmo de aprendizaje personalizado."
            />
            <CardInfo
            icon={<FaLaptop  />} 
